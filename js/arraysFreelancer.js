...
}, 0);//<-- ноль это первое значение previousValue т.е начинаем с нуля
...
// let users = ['Vania', 'Ishtvan'];
// let newUser = users;
// newUser.push('Ola');
// let removed = users.splice(1, 1, 'Petia');
// let removed1 = users.splice(0, 1,);
...
// let removed2 = arr.splice(1, 1);
// console.log(removed2);


// let str1 = 'Ваня,Иштван,Оля';
